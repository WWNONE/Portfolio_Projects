...
typedef struct varDeclType {
		int symIndex;
		int arraySize;
} varDecl;

//==================| Added Functions |==================//
EXTERN(void, emitConditionalJump,(DList instList, const char* label, SymTable symtab, int regIndex));
EXTERN(void, emitUnconditionalJump,(DList instList, char* label, SymTable symtab));
EXTERN(void, emitLabel,(DList instList, const char* label));
//=======================================================//
...
EXTERN(int, emitComputeVariableArrayAddress, (DList instList, SymTable symtab, int varIndex, int exprRegIndex));
